...
@section('content')
    ...
    <div class="pb-5">
        ...
        <div class="row py-5 p-4 bg-white rounded shadow-sm">
            <div class="col-lg-6">
            <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Coupon code (cette partie du code ne fontionne pas)</div>
            <div class="p-4">
                <p class="font-italic mb-4">cette partie de code ne fonctionne pas</p>
            ...
            <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Instructions for seller (cette partie du code ne fonctionne pas)</div>
            <div class="p-4">
                <p class="font-italic mb-4">cette partie du code ne fonctionne pas</p>
            ...
            <div class="p-4">
             ...
             <!--   <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Shipping and handling</strong><strong>$10.00</strong></li> -->
                ...
                </ul><a href="{{ route('checkout.index') }}" class="btn btn-dark rounded-pill py-2 btn-block">Finaliser la commande</a>
            </div>
            </div>
        </div>
